...
The interpreter was built specifically to run programs from the Turbo Pascal era (including a two-player PONG game that I wrote in Turbo Pascal 3 and published in Pascal International, February 1988).
